(async () => {
  ...
  console.log(chalk.white.bold("  | GitHub: ") + chalk.cyan.bold("https://github.com/Bhuzel"));
  console.log(chalk.white.bold("  | Developer: ") + chalk.green.bold("Bhuzel"));
